      ...
      <div className="w-full max-w-md px-4">
        ...
        >
          <form onSubmit={handleSubmit}>
            <div className="mb-5">
              <label htmlFor="login-email" className="block text-sm mb-2" style={{ color: "var(--text-secondary)" }}>
                Email
              </label>
              <input
                id="login-email"
            ...
            <div className="mb-6">
              <label htmlFor="login-password" className="block text-sm mb-2" style={{ color: "var(--text-secondary)" }}>
                Password
              </label>
              <input
                id="login-password"
