  ...
  return (
    <div className="mb-3">
      ...
      >
        <span>{open ? "▼" : "▶"}</span>
        <span>
          Thought with {agentCount} advisor{agentCount !== 1 ? "s" : ""}
        </span>
      </button>
      {open && (
        <div
...
export default function Boardroom({ user, onLogout }: BoardroomProps) {
  ...
  const { messages, sendMessage, isStreaming, clearMessages, sessions, loadSession, sessionId } =
    useChat((event) => {
                            ...
                            {group.answer && (
                              <div
                                ...
                                dangerouslySetInnerHTML={{
                                  __html: renderMarkdown(group.answer.content),
                                }}
                              />
                            )}
                          </>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <textarea
                ...
                placeholder={
                  voiceState === "recording" ? "Listening..." : "Ask your Boardroom anything..."
                }
                rows={2}
              ...
              <button
                ...
                style={{
                  background:
                    inputValue.trim() && !isStreaming ? "var(--accent)" : "var(--bg-card)",
                  border: "none",
            ...
            {voiceError && (
              <div className="mt-1 text-xs px-2" style={{ color: "#f87171" }}>
                {voiceError}
              </div>
            )}
            <div
